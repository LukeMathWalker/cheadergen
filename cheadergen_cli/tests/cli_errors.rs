...
fn unknown_field_rejected() {
    ...
    1 | bogus = true
      | ^^^^^
    unknown field `bogus`, expected one of `preamble`, `trailer`, `autogen_warning`, `pragma_once`, `sys_includes`, `includes`, `no_includes`, `after_includes`, `documentation`, `documentation_style`, `documentation_length`, `sort_by`, `fn`, `static`, `constant`, `enum`, `package`, `header`, `c`, `c++`, `cpp`, `cxx`
    "###);
}
