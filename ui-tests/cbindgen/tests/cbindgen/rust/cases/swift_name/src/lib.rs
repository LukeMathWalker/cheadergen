...
#[unsafe(export_name = "rust_print_hello_world")]
...
impl SelfTypeTestStruct {
  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_ref")]
  #[unsafe(no_mangle)]
  pub extern fn should_exist_ref(&self) {
    println!("should_exist_ref");
  }

  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_ref_mut")]
  #[unsafe(no_mangle)]
  pub extern fn should_exist_ref_mut(&mut self) {
    println!("should_exist_ref_mut");
  }

  #[unsafe(export_name = "SelfTypeTestStruct_should_not_exist_box")]
  #[unsafe(no_mangle)]
  pub extern fn should_not_exist_box(self: Box<SelfTypeTestStruct>) {
    println!("should_not_exist_box");
  }

  #[unsafe(export_name = "SelfTypeTestStruct_should_not_exist_return_box")]
  #[unsafe(no_mangle)]
  pub extern fn should_not_exist_box() -> Box<Self> {
    println!("should_not_exist_box");
  }

  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_annotated_self")]
  #[unsafe(no_mangle)]
  pub extern fn should_exist_annotated_self(self: Self) {
    println!("should_exist_annotated_self");
  }

  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_annotated_mut_self")]
  #[unsafe(no_mangle)]
  #[allow(unused_mut)]
  ...
  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_annotated_by_name")]
  #[unsafe(no_mangle)]
  pub extern fn should_exist_annotated_by_name(self: SelfTypeTestStruct) {
    println!("should_exist_annotated_by_name");
  }

  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_annotated_mut_by_name")]
  #[unsafe(no_mangle)]
  #[allow(unused_mut)]
  ...
  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_unannotated")]
  #[unsafe(no_mangle)]
  pub extern fn should_exist_unannotated(self) {
    println!("should_exist_unannotated");
  }

  #[unsafe(export_name = "SelfTypeTestStruct_should_exist_mut_unannotated")]
  #[unsafe(no_mangle)]
  #[allow(unused_mut)]
